...
class TestCartPageWithoutProducts():
    ...
    def test_a_cart_with_no_product_product_page(self):
        try:
            ...
            self.driver.get_screenshot_as_file("/Users/yuchienhuang/Desktop/Swag_labs/Funtionality_Reports/cart_page/cart_page_screenshots/cart_page_problem_user/" + screenshotName + ".png")
